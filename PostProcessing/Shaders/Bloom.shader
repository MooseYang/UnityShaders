...
Shader "Moose_Yang/PostProcessing/Bloom"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Moose_Yang/PostProcessing/GaussianBlur/GAUSSIAN_HOR"

		UsePass "Moose_Yang/PostProcessing/GaussianBlur/GAUSSIAN_VERT"
