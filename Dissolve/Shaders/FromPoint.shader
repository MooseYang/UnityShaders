...
Shader "Moose_Yang/Dissolve/FromPoint"
{
	Properties
	{
		...
		_MaxDistance("Max Distance", Float) = 0  // C#脚本计算后，传入
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				float normalizedDist = saturate(dist / _MaxDistance);  //_Maxdistance: 网格内两点的最大距离
				//_DistanceEffect: 控制距离值对整个消融的影响程度
